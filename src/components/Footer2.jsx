        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-[50px] h-[50px] bg-white dark:bg-gray-900 border-[2px] border-black dark:border-white rounded-full flex items-center justify-center hover:scale-105 transition-transform text-black dark:text-white">
