...
export default function CareersHero() {
  return (
    <section className="relative min-h-[80vh] flex flex-col items-center justify-center pt-32 pb-16 overflow-hidden bg-[#F5F5F5]">
      {/* Background Styling: Subtle pattern or gradient if needed, matching the requested plain white/gray look */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-5xl mx-auto px-4">
        ...
        <motion.div
          ...
          className="flex items-center justify-center bg-white border border-[#800000] rounded-[5px] px-4 py-1.5 mb-8"
          style={{
            width: 'fit-content'
          }}
        >
        ...
        <motion.h1
          ...
          className="font-pangram text-black text-center tracking-[-0.02em] mb-8"
          style={{
            fontWeight: 617,
            fontSize: '69px',
            lineHeight: '75px'
        ...
        >
          We’re With You on <br className="hidden md:block" />
          <span className="inline-flex items-center gap-4">
            Your Career
            <img 
              src="/per-market-hero.png" 
              alt="Icon" 
