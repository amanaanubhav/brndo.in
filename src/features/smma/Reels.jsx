...
const placeholderReels = [
  { id: 1, title: 'Media Placeholder 1' },
  { id: 2, title: 'Media Placeholder 2' },
  { id: 3, title: 'Media Placeholder 3' },
  { id: 4, title: 'Media Placeholder 4' },
];

export default function SMMAReels() {
  ...
  return (
    <section className="py-8 md:py-12 bg-white dark:bg-gray-950 transition-colors duration-300 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 w-full flex items-center gap-4">
