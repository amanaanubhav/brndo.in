...
export default function SMMAResults() {
  const cards = [
    {
      stat: '767+',
      title: 'Followers Monthly',
      subtitle: 'Average across client accounts without paid promotion'
    },
    {
      stat: '186%',
      title: 'Engagement Rate Increase',
      subtitle: 'Improvement in meaningful interactions within first 90 days'
    },
    {
      stat: '41+',
      title: 'Content Pieces That Went Viral',
      subtitle: 'Organic posts that achieved 10x average reach across all client accounts'
    },
    {
      stat: '₹3.39M',
      title: 'Revenue Generated',
      subtitle: 'Total average revenue across accounts driven directly from organic social media efforts in 3 months'
    }
  ];
  ...
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-gray-950 transition-colors duration-300 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col items-center">
        ...
        {/* Header Block */}
        <SectionHeading title={sectionHeadings.smmaResults} className="-mb-16 md:-mb-24 mt-8" />
        ...
        <div className="relative z-10 w-full flex flex-col items-center mt-12 md:mt-16">
          ...
          >
            Through source-led branding, professional content creation <br className="hidden lg:block" /> & data-driven optimization on Instagram
          </motion.h5>
